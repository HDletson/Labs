    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoAirport.equals(_existingAirport)) {
          return new RoomOpenHelper.ValidationResult(false, "airport(com.example.flightsearch.model.Airport).\n"
                  + " Expected:\n" + _infoAirport + "\n"
                  + " Found:\n" + _existingAirport);
        }
        ...
        if (! _infoFavorite.equals(_existingFavorite)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite(com.example.flightsearch.model.Favorite).\n"
                  + " Expected:\n" + _infoFavorite + "\n"
                  + " Found:\n" + _existingFavorite);
        }
